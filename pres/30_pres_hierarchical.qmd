...
#| fig-height: 4
library(ggplot2)
ggplot(data.rcb, aes(y = y, x = x, colour = block)) +
    geom_point() +
  geom_smooth(method = "lm") +
  theme_classic()
```
...
Note, I have plotted the residuals against the blocks
