...
git status
```
```{r, engine='bash', prompt=FALSE,eval=TRUE, echo=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo1.tex
#cp 10_pres_git_Test_repo1.log ../docs
#cp 10_pres_git_Test_repo1.tex ../docs
cp 10_pres_git_Test_repo1.pdf resources/10_pres_git_Test_repo1.pdf
```
### RStudio
...
```{bash, echo=FALSE, eval=TRUE, include=FALSE}
convert resources/RStudio_GitCommit.png -resize 400x resources/RStudio_GitCommit_small.png
convert -density 300 resources/10_pres_git_Test_repo1.pdf -resize 350x resources/10_pres_git_Test_repo1.png
```
...
```{r, engine='bash',results="hide", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
...
```
![](resources/Test_repo1_small.png)
![](resources/10_pres_git_Test_repo1.png)
...
```{r, engine='bash',results="hide", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo2.tex
mv 10_pres_git_Test_repo2.pdf resources/10_pres_git_Test_repo2.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo2.pdf resources/10_pres_git_Test_repo2.png
rm 10_pres_git_Test_repo2.tex
```
```{r, engine='bash',results="hide", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
...
![](resources/Test_repo2.png)
![](resources/10_pres_git_Test_repo2.png)
...
![](resources/Rstudio_GitLog_small.png)
![](resources/10_pres_git_Test_repo2.png)

Git - history (logs)
---------------------

```{r gert_log, results='markdown', eval=TRUE, echo=2}
...
```{r gert_ls, results='markdown', eval=TRUE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
gert::git_ls()
setwd(oldwd)
```
...
```
```{r, engine='bash',results="markup", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo3.tex
mv 10_pres_git_Test_repo3.pdf resources/10_pres_git_Test_repo3.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo3.pdf resources/10_pres_git_Test_repo3.png
rm 10_pres_git_Test_repo3.tex
```

![](resources/10_pres_git_Test_repo2.png)
![](resources/10_pres_git_Test_repo3.png)

### R/RStudio

```{r gert_tag, results='markdown', eval=FALSE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
...
```
<!--![](resources/RStudio_GitTag_small.png)--><br>
![](resources/RStudio_GitTag1_small.png)
...
1. **checkout**
![](resources/10_pres_git_Test_repo6.png)

2. **reset**
![](resources/10_pres_git_Test_repo4.png)

3. **revert**
![](resources/10_pres_git_Test_repo5.png)
...
```{r, engine='bash1',results="markup", prompt=FALSE,eval=TRUE,echo=-1}
cd ~/tmp/Test_repo
git checkout #
```

```{r, engine='bash',results="markup", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo6.tex
mv 10_pres_git_Test_repo6.pdf resources/10_pres_git_Test_repo6.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo6.pdf resources/10_pres_git_Test_repo6.png
rm 10_pres_git_Test_repo6.tex
```
...
```{r gert_checkout, engine='r', results='markdown', eval=FALSE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
...
![](resources/RStudio_GitTag_small.png)
![](resources/RStudio_GitCheckout1_small.png)
...
```
```{r, engine='bash',results="markup", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo7.tex
mv 10_pres_git_Test_repo7.pdf resources/10_pres_git_Test_repo7.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo7.pdf resources/10_pres_git_Test_repo7.png
rm 10_pres_git_Test_repo7.tex
```

![](resources/10_pres_git_Test_repo6.png)
![](resources/10_pres_git_Test_repo7.png)
...
![](resources/RStudio_GitBranch_change_small.png)

```{r gert_checkout2, engine='r', results='markdown', eval=FALSE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
...
```
\# is a commit or tag name
```{r, engine='bash1',results="hide", prompt=FALSE,eval=TRUE,echo==-1}
cd ~/tmp/Test_repo
git reset --hard #
```
...
::: {.column .center style="width:45%;"}
```{r, results='markdown', eval=TRUE, echo=FALSE}
knit_hooks$set(source = sub_hook)
```
```{r gert_reset_hard, results='markdown', eval=FALSE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
...
<!--![](resources/RStudio_GitTag_small.png)-->
![](resources/RStudio_GitReset1_small.png)
:::
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo4.tex
mv 10_pres_git_Test_repo4.pdf resources/10_pres_git_Test_repo4.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo4.pdf resources/10_pres_git_Test_repo4.png
```
![](resources/Test_repo4.png)
![](resources/10_pres_git_Test_repo4.png)
...
```
```{r, engine='bash',results="markup", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo8.tex
mv 10_pres_git_Test_repo8.pdf resources/10_pres_git_Test_repo8.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo8.pdf resources/10_pres_git_Test_repo8.png
```

![](resources/10_pres_git_Test_repo4.png)
![](resources/10_pres_git_Test_repo8.png)

### R

```{r gert_reset_hard1, results='markdown', eval=FALSE, echo=2}
oldwd=setwd('~/tmp/Test_repo')
...
```
![](resources/RStudio_GitTag_small.png)
![](resources/RStudio_GitRevert1_small.png)
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo5.tex
mv 10_pres_git_Test_repo5.pdf resources/10_pres_git_Test_repo5.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo5.pdf resources/10_pres_git_Test_repo5.png
```
![](resources/Test_repo5.png)
![](resources/10_pres_git_Test_repo5.png)
...
![](resources/10_pres_git_Test_repo5.png)
![](resources/10_pres_git_Test_repo9.png)
...
```
![](resources/RStudio_GitBranch_small.png)
![](resources/RStudio_GitBranch1_small.png)
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo9.tex
mv 10_pres_git_Test_repo9.pdf resources/10_pres_git_Test_repo9.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo9.pdf resources/10_pres_git_Test_repo9.png
```

![](resources/Test_repo9.png)
![](resources/10_pres_git_Test_repo9.png)
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo10.tex
mv 10_pres_git_Test_repo10.pdf resources/10_pres_git_Test_repo10.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo10.pdf resources/10_pres_git_Test_repo10.png
```

![](resources/Test_repo10.png)
![](resources/10_pres_git_Test_repo10.png)
...
![](resources/10_pres_git_Test_repo10.png)
![](resources/10_pres_git_Test_repo11.png)
...
```
![](resources/RStudio_GitBranch3_small.png)
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo11.tex
mv 10_pres_git_Test_repo11.pdf resources/10_pres_git_Test_repo11.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo11.pdf resources/10_pres_git_Test_repo11.png
```
![](resources/Test_repo11.png)
![](resources/10_pres_git_Test_repo11.png)
...
![](resources/10_pres_git_Test_repo11.png)
![](resources/10_pres_git_Test_repo12.png)
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo12.tex
mv 10_pres_git_Test_repo12.pdf resources/10_pres_git_Test_repo12.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo12.pdf resources/10_pres_git_Test_repo12.png
```

![](resources/Test_repo12.png)
![](resources/10_pres_git_Test_repo12.png)
...
```
![](resources/RStudio_GitBranch5_small.png)
...
![](resources/10_pres_git_Test_repo12.png)
![](resources/10_pres_git_Test_repo13.png)


### RStudio

```{r gert_merge, results='markdown', eval=FALSE, echo=2:3}
oldwd=setwd('~/tmp/Test_repo')
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo13.tex
mv 10_pres_git_Test_repo13.pdf resources/10_pres_git_Test_repo13.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo13.pdf resources/10_pres_git_Test_repo13.png
```
![](resources/Test_repo12.png)
![](resources/10_pres_git_Test_repo12.png)
...
- Step 1. get a github account and verify email address<br>
- Step 2. create one (or more) Personal Access Tokens (**PAT**)<br>
  - more nuanced than a single password
- Step 3. create a **remote repository** on github<br>
- Step 4. push/pull between remote and local


## Personal Access Token

- [Github docs instructions](https://docs.github.com/en/github/authenticating-to-github/keeping-your-account-and-data-secure/creating-a-personal-access-token)

### R

- Generate token in github
```{r create_github_token, results='markdown', eval=FALSE}
usethis::create_github_token()
```
- copy token
- store token in manager (Keychain etc)
```{r gitcreds_set, results='markdown', eval=FALSE}
gitcreds::gitcreds_set()
```
- confirm
```{r gitcreds_get, results='markdown', eval=FALSE}
...
```{r use_git_hub, results='markdown', eval=FALSE}
usethis::use_github()
```
...
```
```{r, engine='bash',results="markup", prompt=FALSE,eval=FALSE,echo=FALSE}
cd ~/tmp/Test_repo
...
### R
```{r git_remote_add, results='markdown', eval=FALSE}
...
../resources/git-tikz --git-dir ~/tmp/Test_repo/.git --filename 10_pres_git_Test_repo14.tex
mv 10_pres_git_Test_repo14.pdf resources/10_pres_git_Test_repo14.pdf
convert  -density 300 -resize 250x resources/10_pres_git_Test_repo14.pdf resources/10_pres_git_Test_repo14.png
```
![](resources/Test_repo14.png)
![](resources/10_pres_git_Test_repo14.png)


Git - push to repo
---------------------

```{r, engine='bash',results="hide", prompt=FALSE,eval=FALSE, echo=-1}
cd ~/tmp/Test_repo
git push -u origin main
```
```{r, engine='bash',results="markup", prompt=FALSE,eval=TRUE, echo=FALSE, include=FALSE}
...
```
![](resources/RStudio_Gitpullpush_small.png)
![](resources/RStudio_Gitpushpull1_small.png)
...
```
![](resources/RStudio_NewProject1_small.png)
![](resources/RStudio_NewProject2_small.png)
![](resources/RStudio_NewProject3_small.png)

Git - pull
-------------

Before making any changes that you intend to push, it is advisable that you pull to get the latest
from the remote
...
- [My online tutorial](http://www.flutterbys.com.au/stats/tut/tut19.1.html)
- [git online resources](https://git-scm.com/docs/gittutorial)
- [git online manual](https://git-scm.com/book/en/v2)
- [Atlassian git tutorials](https://www.atlassian.com/git/tutorials)
- [A visual git tutorial](https://marklodato.github.io/visual-git-guide/index-en.html)
- [Visualizing git online tool](http://git-school.github.io/visualizing-git/)
- [Another git visualizing tool](https://onlywei.github.io/explain-git-with-d3/)
- [github online resources](https://try.github.io/levels/1/challenges/1)
- [bit-booster](http://bit-booster.com/graph.html)
...
<!--https://github.com/sensorflo/git-draw/blob/master/git-draw-->
