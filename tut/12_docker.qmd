...
#| highlight-style: zenburn
cd ~/tmp/docker_tests/
docker run --privileged --entrypoint Rscript --rm -v $(pwd):/home/Project -w /home/root/tmp/docker_tests r:2 -e "Sys.info()['user']; list.files(); getwd(); list.files('/'); list.files('~'); list.files('/home');list.files('/home/Project');list.files('/workspace');"
```
