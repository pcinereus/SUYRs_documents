...
#| echo: false
#| cache: false
mkdir -p $HOST_PWD/docker_tests
cp ~/tmp/docker_tests/analysis.R $HOST_PWD/docker_tests/analysis.R
```
...
#| code-line-numbers: false
#| highlight-style: zenburn
docker run --rm -v $HOST_PWD/docker_tests:/home/Project r:2
```
...
#| code-line-numbers: false
#| highlight-style: zenburn
docker run --rm -v $HOST_PWD/docker_tests:/home/Project r-tidyverse:1
```
...
#| cache: false
mkdir -p $HOST_PWD/docker_tests
cp ~/tmp/docker_tests/analysis5.R $HOST_PWD/docker_tests/analysis5.R
```
...
#| class-output: terminal
#| code-line-numbers: false
docker run --rm -v $HOST_PWD/docker_tests:/home/Project r-tidyverse:1 analysis5.R
```
