...
#| echo: true
#| cache: false
work_dir <- Sys.getenv("GITHUB_WORKSPACE")
work_dir
work_dir <- Sys.getenv("HOST_PWD")
work_dir
...
cp ~/tmp/docker_tests/analysis.R $HOST_PWD/analysis.R

ls -lat $GITHUB_WORKSPACE
...
# ls -lat $(HOST_PWD)
# ls -lat $HOST_PWD
# ls -lat $HOST_PWD/docs
# ls -lat /home/runner/work/SUYRs_documents/SUYRs_documents
# find / -name analysis.R

cp ~/tmp/docker_tests/analysis.R $GITHUB_WORKSPACE/analysis.R
ls -lat $GITHUB_WORKSPACE

# docker run --rm -v $(pwd):/home/Project r:2 bash -c "ls -lat /home/Project && cat /etc/os-release && pwd && env"

# docker run --rm -v $(pwd):/home/Project r:2 ls -lat /home/Project

#docker run --rm -v $GITHUB_WORKSPACE:/home/Project r:2
```
