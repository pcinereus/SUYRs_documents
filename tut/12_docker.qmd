...
#| code-line-numbers: false
#| highlight-style: zenburn
cp ~/tmp/docker_tests/analysis.R /workspace/analysis.R
cp ~/tmp/docker_tests/analysis.R ${{ github.workspace }}/analysis.R
ls -lat /workspace
cd ~/tmp/docker_tests/
pwd
ls -lat
...
docker run --rm -v $(pwd):/home/Project --entrypoint "ls" r:2 -lat
docker run --rm -v $(pwd):/home/Project --entrypoint "pwd" r:2
docker run --rm -v ${{ github.workspace}}:/home/Project --entrypoint "ls" r:2 -lat
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v /workspace:/home/Project r:2 "analysis.R"
```
